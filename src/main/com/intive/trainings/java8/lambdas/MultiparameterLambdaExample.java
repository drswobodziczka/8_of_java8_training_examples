...
public class MultiparameterLambdaExample {
     ...
     */
    @FunctionalInterface
    interface MultiParamFunction<A, B, C, D, E> {
    ...
    public static void main(String[] args) {
         ...
         * */
        MultiParamFunction<Integer, String, Double, Boolean, Integer> multiparamFunction =
                (a, b, c, d) -> 2;

        MultiParamFunction<Integer, Integer, Integer, Integer, Long> f =
